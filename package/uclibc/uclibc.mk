...
UCLIBC_METAG_TYPE = CONFIG_META_$(call qstrip,$(BR2_UCLIBC_METAG_TYPE))
define UCLIBC_METAG_TYPE_CONFIG
	$(call UCLIBC_OPT_SET,$(UCLIBC_METAG_TYPE),y,$(@D))
endef
endif
